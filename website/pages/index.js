                ...
                <div id='main'>
                    ...
                    <div id='content'>
                        ...
                        <div className='codeWrapper'>
                            ...
                            <button className='codeSection copyable' onClick={()=>copyTextToClipboard('npm i awesome-selector')}>
                                <p>npm i <span>awesome-selector</span></p>
                            </button>
                            <p className='comment'># yarn</p>
                            <button className='codeSection copyable' onClick={()=>copyTextToClipboard('yarn add awesome-selector')}>
                                <p>yarn add <span>awesome-selector</span></p>
                            </button>
                            <p className='comment'>
                        ...
                        <div className='codeWrapper'>
                            ...
                            <button className='codeSection copyable' onClick={()=>copyTextToClipboard('import Selector from \'awesome-selector\'')}>
                                <p>import <span>Selector</span> from <span>&apos;awesome-selector&apos;</span></p>
                            </button>
                        </div>
